...
function headerScroll() {
  ...
  const headerShowTimer = header.dataset.flsHeaderScrollShow ? header.dataset.flsHeaderScrollShow : 300;
...
document.querySelectorAll(".media-about").forEach((wrapper) => {
  const video = wrapper.querySelector(".media-about__video");
  const btn = wrapper.querySelector(".media-about__button");
